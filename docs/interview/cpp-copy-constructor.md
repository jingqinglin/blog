...
<img src="https://raw.githubusercontent.com/JingqingLin/ImageHosting/master/img/1917068-20200324230227554-461166612.jpg" width="70%"/>

在使用 rect1 复制 rect2 时，由于执行的是浅拷贝，只是将成员的值进行赋值，这时 rect1.p = rect2.p，也即这两个指针指向了堆里的同一个空间，如下图所示：

<img src="https://cdn.jsdelivr.net/gh/JingqingLin/ImageHosting@master/img/17145d10b36baf75.png" width="60%"/>
