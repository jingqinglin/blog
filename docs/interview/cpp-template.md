...
例 2 中最后一行的结果正是您所期望的。然而，今天的问题是，你为什么期望这个结果。如果你的解释是错误的，你会对接下来发生的事情感到非常惊讶。毕竟，有人会说：“那又怎样，我为一个指向 int 的指针写了一个特化，所以很明显这就是应该被调用的”——这正是错误的原因。
...
但是如果你是一个编写，而不仅仅是使用函数模板的人呢？为了你自己和你的用户，你能做得更好并避免这个（和其他）问题吗？实际上，您可以：
