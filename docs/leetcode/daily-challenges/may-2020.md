...
> 本题为「[面试题56 - I](https://leetcode-cn.com/problems/shu-zu-zhong-shu-zi-chu-xian-de-ci-shu-lcof/). 数组中数字出现的次数」的简化版本，此题题解[传送门](leetcode/daily-challenges/april-2020?id=_21-⭐-数组中数字出现的次数)
