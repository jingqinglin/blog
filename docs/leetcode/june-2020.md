...
打卡完毕 🎉。每日一题完结了，四个月 122 题覆盖了大部分算法题型，我从中学到了很多，但因为“战线”拉得太长，很多解题思想都遗忘了，需要时不时进行复习。

四月底的时候确定了实习地点，之后做每日一题的动力就有点不足，但出于强迫症不想“断签”，也为以后可以更方便地复习，因此做了一个简单的记录。

![](_images/june-medal.png ':class=image-30')
