...
![](_images/june-medal.png ':size=30%')
...
![](_images/june-8-1.png ':size=80%')<font size="2" color="#8590a6">图片来自[力扣](https://leetcode-cn.com/problems/ba-shu-zi-fan-yi-cheng-zi-fu-chuan-lcof/solution/shou-hui-tu-jie-dfsdi-gui-ji-yi-hua-di-gui-dong-ta/)</font>
