...
$dp_{max}[i] = \max(dp_{max}[i - 1] * nums[i], dp_{min}[i - 1] * nums[i], nums[i])$

$dp_{min}[i] = \min(dp_{max}[i - 1] * nums[i], dp_{min}[i - 1] * nums[i], nums[i])$
